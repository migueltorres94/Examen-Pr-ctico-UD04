 ...
 */
public class HuevoSorpresaMiguelTorresPeralvarez {
 ...
 */
public HuevoSorpresaMiguelTorresPeralvarez(){}
 ...
 */
public HuevoSorpresaMiguelTorresPeralvarez(int unidades, double precio, String sorpresa, double precio_max){
 ...
 * @param unidades permite modificar el número de huevos sorpresa que tiene la tienda
 */
 ...
 * @param unidades número de huevos que quedan
 * @param dinero dinero que pasa por parametro
 * @param sorpresa nombre de la sorpresa que incluye huevo sorpresa
 * @throws Exception 
 */
 ...
 * @param aumento aumento que quiere realizar
 * @throws Exception 
 */
